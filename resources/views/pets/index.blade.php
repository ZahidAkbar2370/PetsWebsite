                ...
                @if(!empty($pets))
                    @foreach($pets as $pet)
                        <div class="featured-pet-card">
                            <a href="{{ url('pet',$pet->id) }}" class="nav-link">
                                ...
                                <div class="featured-pet-content">
                                    ...
                                    <strong>Gender: </strong><span class="text-center m-0 text-uppercase">{{ $pet->gender }}</span>
                                    <strong>Age: </strong><span class="text-center m-0 text-uppercase">{{ $pet->age }}</span>
                                    {{-- <span class="text-center m-0">{{ $pet->color }}</span> --}}
                                </div>
                            </a>
                </div>
                @endforeach
