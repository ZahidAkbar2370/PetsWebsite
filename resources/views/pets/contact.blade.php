    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">Softwebies Layyah</div>
          {{-- <div class="text-two">M1H1V6</div> --}}
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div>
          <div class="text-one">+923081312527</div>
          {{-- <div class="text-two">+1647 445 3200</div> --}}
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">RayanPetsZone@gmail.com</div>
      ...
      <form action="{{ route('send-email', 'admin') }}" method="POST">
        ...
        <div class="back"> <br> Contact Through Whatsapp? <a class="nav-link fw-bold d-inline" target="_blank" href="">+923081312527</a></div>
      </form>
    </div>
    </div>
  </div>
